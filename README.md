...
<p align="center">
  A detail-oriented Software Developer with expertise in <strong>Python, Django, Frappe Framework, and React</strong>.<br/>
  Passionate about building <strong>AI-powered applications</strong>, autonomous AI agents, and scalable backend systems.<br/>
  Skilled in DevOps, API integrations, and cloud-native infrastructure.
</p>
...
- 🤖 In my free time, I **build AI Agents using Agno Framework** and explore autonomous agent workflows
- 🌱 Constantly **reading articles, experimenting with new tools** — diving deep into AI Agents, RAG pipelines, and multi-agent systems
- 📚 Always exploring **new tech, frameworks, and ideas** to stay sharp and grow as a developer
- 👨‍💻 All projects available at [github.com/deepak982](https://github.com/deepak982)
- 💬 Ask me about **Frappe Framework, Python, Django, REST APIs, AI Agents, Docker, and Kubernetes**
- 📫 Reach me at **deepakmalik982@yahoo.com**
...
<p align="center">
  <a href="https://linkedin.com/in/deepak-malik-4b60a4188" target="blank">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/>
  </a>
  &nbsp;
  <a href="https://www.hackerrank.com/dk2446543" target="blank">
...
| What I do | Details |
|---|---|
| 🤖 **Autonomous AI Agents** | Build agents that interact with external tools, APIs, and databases using Agno Framework |
| 📄 **RAG Pipelines** | Implement Retrieval-Augmented Generation for intelligent document Q&A |
| ⚡ **LLM Integration** | Integrate LLMs into Frappe/ERPNext for smart automation and business optimization |
| 🔗 **Multi-step Workflows** | Design multi-step agent workflows with function calling and tool-use patterns |
...
| Skill | Details |
|---|---|
| 🏗️ **Custom App Dev** | DocTypes, Controllers, Server Scripts, Hooks |
| 🔌 **REST APIs** | API design and third-party integrations within Frappe |
| 🔐 **Permissions & Reports** | Role-based permissions, workflows, custom reports in ERPNext |
| 🐳 **Docker Deployment** | Production-grade Frappe with Nginx + Redis + MariaDB stacks |
| ⚛️ **Frappe + React** | Hybrid frontends for modern UI experiences |
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/shadcn%2Fui-09090B?style=for-the-badge&logo=shadcnui&logoColor=white" alt="shadcn/ui"/>
